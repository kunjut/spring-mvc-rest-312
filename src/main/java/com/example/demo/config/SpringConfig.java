...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        props.put("spring.jpa.show-sql", env.getProperty("spring.jpa.show-sql"));
        props.put("spring.jpa.hibernate.ddl-auto", env.getProperty("spring.jpa.hibernate.ddl-auto"));
